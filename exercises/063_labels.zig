...
pub fn main() void {
    ...
    const meal = food_loop: for (menu) |food| {
        ...
        break food; // LBK _ I took so long to understand that I have to explicitly return the variable I want
        // Earlier the errors kept talking about void types because I hadn't returned anything from the loop
    } else break :food_loop menu[0];
